...
// // // // // connection string- you can write localhost or 127.0.0.1 if it gives the axios error
...
// // // // app.post('/create', verifyUser, upload.single('file'), async (req, res) => {
// // // //   try {
// // // //     // Find logged-in user using email from JWT
// // // //     const user = await UserModel.findOne({ email: req.email });
...
// // // //       folder: 'blog_posts', // optional folder in Cloudinary
// // // //     });

// // // //     // Save post with author as ObjectId
// // // //     const post = await PostModel.create({
// // // //       title: req.body.title,
// // // //       subtitle: req.body.subtitle,
// // // //       content: req.body.content,
...
// // // // // GET all posts safely (no populate)
// // // // app.get('/getposts', async (req, res) => {
// // // //   try {
// // // //     // Fetch posts only
// // // //     const posts = await PostModel.find().sort({ createdAt: -1 });
...
// // // //       // Manually fetch author document
// // // //       if (post.author) {
// // // //         const author = await UserModel.findById(post.author).select("username");
// // // //         if (author) {
...
// // // //         imageUrl: post.imageUrl, // already a Cloudinary URL
...
// // // // app.listen(3000,()=>{
// // // // console.log(`Node API is running on port:3000 right now`);
// // // // })
